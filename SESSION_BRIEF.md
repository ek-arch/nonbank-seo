...
- Added **GEO Tracker** page to app (Growth → GEO Tracker) with 4 tabs:
  ...
  - Tab 2: Monitor — queries Perplexity for each prompt, checks Nonbank mention/citation
...
## Key Reminders
- **nonbank.io redirects to nonbank.io** — same site, two domains
- **NOT "in Telegram"** — Nonbank is multi-platform (iOS, Android, Telegram, web)
...
- GSC property: `sc-domain:nonbank.io`
