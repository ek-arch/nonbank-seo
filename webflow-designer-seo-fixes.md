# Webflow Designer — SEO Fix Checklist for nonbank.io
...
```html
<link rel="alternate" hreflang="en" href="https://nonbank.io/{page}" />
<link rel="alternate" hreflang="ru" href="https://nonbank.io/ru/{page}" />
<link rel="alternate" hreflang="uk" href="https://nonbank.io/ua/{page}" />
<link rel="alternate" hreflang="x-default" href="https://nonbank.io/{page}" />
```
...
- `/ru/exchanger` → canonical = `https://nonbank.io/ru/exchanger`
- `/ua/exchanger` → canonical = `https://nonbank.io/ua/exchanger`
...
|------|-------|-------------|
| Home | Nonbank — Крипто Visa Карта и USDT Кошелёк \| Траты в 60+ странах | Криптокарта Visa с кэшбэком в BTC. Мультиплатформа — iOS, Android, Telegram и веб. Низкие комиссии, мгновенные переводы USDT. |
| Buy Crypto | Купить Криптовалюту Картой — USDT, BTC, ETH \| Nonbank | Мгновенная покупка криптовалюты банковской картой. Низкие комиссии, быстрое зачисление. |
| Countries | Крипто Карта в 60+ Странах — Европа, ОАЭ и Другие \| Nonbank | Используйте криптокарту Nonbank для оплаты в более чем 60 странах мира. Европа, Великобритания, ОАЭ, СНГ. |
| Blog | Блог о Криптокартах — Новости и Гайды \| Nonbank | Новости криптовалют, руководства по использованию крипто карт и советы по экономии на комиссиях. |
| Business | Крипто для Бизнеса — B2B Платежи и Корпоративные Карты \| Nonbank | Принимайте криптоплатежи, выпускайте корпоративные Visa карты. Низкие комиссии, мгновенные USDT-расчёты. |
| Cashback | BTC Кэшбэк — 2% за Каждую Покупку \| Nonbank | Получайте кэшбэк в биткоинах за каждую покупку криптокартой Nonbank. |

### Ukrainian (/ua/) pages

| Page | Title | Description |
|------|-------|-------------|
| Home | Nonbank — Крипто Visa Картка та USDT Гаманець \| Витрати в 60+ країнах | Криптокартка Visa з кешбеком у BTC. Мультиплатформа — iOS, Android, Telegram та веб. |
| Buy Crypto | Купити Криптовалюту Карткою — USDT, BTC, ETH \| Nonbank | Миттєва купівля криптовалюти банківською карткою. Низькі комісії. |
| Countries | Крипто Картка у 60+ Країнах — Європа, ОАЕ та Інші \| Nonbank | Використовуйте криптокартку Nonbank для оплати у понад 60 країнах світу. |
| Blog | Блог про Криптокартки — Новини та Гайди \| Nonbank | Новини криптовалют, інструкції з використання крипто карток та поради. |
| Business | Крипто для Бізнесу — B2B Платежі та Корпоративні Картки \| Nonbank | Приймайте криптоплатежі, випускайте корпоративні Visa картки. |
| Cashback | BTC Кешбек — 2% за Кожну Покупку \| Nonbank | Отримуйте кешбек у біткоїнах за кожну покупку криптокарткою Nonbank. |
...
The template should match nonbank.io brand:
...
- **CTA button:** Links to `https://nonbank.io` or deep link to card order
