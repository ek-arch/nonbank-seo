...
def _get_all_briefs():
    ...
    if geo_results:
        ...
        not_visible = [r for r in geo_results if not r.get("error") and not r.get("nonbank_visible")]
...
- **Quotable stat paragraphs** — dense facts AI can cite (e.g. "Nonbank supports 40+ countries with 0% FX markup")
- **Comparison tables** — Nonbank vs competitors in structured format AI engines parse easily
