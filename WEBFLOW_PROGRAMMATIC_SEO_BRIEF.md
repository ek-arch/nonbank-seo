# Webflow Designer Brief — Programmatic SEO Pages for nonbank.io

**For:** Webflow Designer with Designer-level access to nonbank.io
**From:** SEO Agent App (nonbank-seo.streamlit.app)
**Goal:** Publish ~41 auto-generated landing pages targeting long-tail crypto card keywords
**Time:** ~30 minutes of Designer work
**URL pattern:** `nonbank.io/crypto-card/{slug}` (e.g. nonbank.io/crypto-card/uae)
...
3. In Collection Settings → **URL Structure** → set prefix to `crypto-card`
   - This makes pages appear at `nonbank.io/crypto-card/{slug}`
...
### Navigation
- Use the existing nonbank.io nav component (copy from homepage)
...
- CTA button: "Get Your Nonbank Card" → link to `https://nonbank.io`
...
- Button: "Get Your Card" → `https://nonbank.io`
...
### Footer
- Use the existing nonbank.io footer component (copy from homepage)
...
1. Open a few pages in the Editor to verify content looks right:
   - `nonbank.io/crypto-card/uae`
   - `nonbank.io/crypto-card/uk`
   - `nonbank.io/crypto-card/kripto-karta-oae` (Russian)
...
- [ ] Verify pages load: `nonbank.io/crypto-card/uae`
- [ ] Check mobile layout
- [ ] Verify sitemap includes new pages: `nonbank.io/sitemap.xml`
- [ ] Submit updated sitemap to Google Search Console (`sc-domain:nonbank.io`)
...
Match the existing nonbank.io brand:
...
| Font | Same as nonbank.io (Inter or system) |
...
## Notes
- **Do NOT create pages for:** US, Russia, Belarus, Turkey, Israel, Kazakhstan, China, India — Nonbank cannot issue cards there
- **nonbank.io and nonbank.io are the same site** — nonbank.io redirects to nonbank.io
- All content is AI-generated and SEO-optimized — no editing needed unless you spot errors
- The CSV is generated by the SEO agent app at nonbank-seo.streamlit.app → Programmatic SEO → Tab 4
- Questions? Contact the SEO team

---

*Generated by Nonbank SEO Agent*
